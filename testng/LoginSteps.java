...
public class LoginSteps extends BaseClass {
    ...
    public void enterCredentials2(String username,String password) {
        // Find username field and enter username
    ...
    public void confirmMessage2(String message2) {
    	if(driver.findElement(By.id("subheading")).isDisplayed()) {
    		String message = driver.findElement(By.id("subheading")).getText();
    		Assertions.assertEquals(message2, message);
    	}
    	else {
        // Find the confirmation message
        wait.until(ExpectedConditions.textToBePresentInElementLocated(By.cssSelector("h2.mt-5"), "Welcome"));
